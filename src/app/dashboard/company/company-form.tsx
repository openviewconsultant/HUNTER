                                    ...
                                    {contracts.length > 0 && (
                                        <div className="mb-8 space-y-3 relative">
                                            {contracts.map((contract) => (
                                                <div key={contract.id} className="p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                                                    <div className="flex justify-between items-start mb-2">
                                                        <div>
                                                            <h4 className="font-semibold text-foreground">{contract.client_name}</h4>
                                                            <p className="text-xs text-primary font-mono">{contract.contract_number}</p>
                                                        </div>
                                                        <div className="text-right">
                                            ...
                                            {/* Floating Button for Managing Contracts */}
                                            <motion.button
                                                initial={{ scale: 0, opacity: 0 }}
                                                animate={{ scale: 1, opacity: 1 }}
                                                onClick={() => setIsManagingContracts(true)}
                                                className="fixed bottom-8 right-8 z-40 flex items-center gap-2 px-6 py-3 bg-primary text-white rounded-full shadow-2xl hover:bg-primary/90 transition-all hover:scale-105"
                                            >
                                                <FileText className="w-5 h-5" />
                                                <span className="font-medium">Gestionar Experiencia</span>
                                            </motion.button>
                                        </div>
                                    )}
